...
class Firebase():
    ...
    def post_realtime(self, script_name:str, duration:str, quantity:int):
        ...
        self.requisition = requests.post(f'{self.link}/Algoritmos/.json', data=json.dumps(data), verify=True)
    ...
    def patch_realtime(self,id:str,username:str,script_name:str,hour_exec:str,duration:str,quantity:int):
        ...
        self.requisition = requests.patch(f'{self.link}/Algoritmos/{id}/.json', data=json.dumps(data), verify=True)

    # GET ALL THE LOGS INSIDE THE DATABASE
    def get_realtime(self):
        self.requisition = requests.get(f'{self.link}/Algoritmos/.json', verify=True).json()
